...
{
    PROFILE_START("goldCodeGenerator");
    auto const start = chrono::high_resolution_clock::now(); // Startzeit für die Laufzeitmessung
    ...
    PROFILE_STOP("goldCodeGenerator");
}
...
int main(const int argc, char *argv[])
{
    ...
    */
    ...
    PROFILE_RUN_ALL(1000, 100, goldCodeGenerator(satellite_register_sums, chip_sequences););
    PROFILE_RUN_ALL(1000, 100, createPrintData(sum_signal, chip_sequences););
